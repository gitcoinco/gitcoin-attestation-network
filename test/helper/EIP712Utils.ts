...
import { EAS, TestEIP1271Verifier } from "./eas-typechain-types";
...
export class EIP712Utils {
  ...
  public async signDelegatedAttestation(
    ...
    return EIP712Utils.signTypedDataRequest<
      EIP712MessageTypes,
  ...
  public async hashDelegatedAttestation(
    ...
    return EIP712Utils.hashTypedData<
      EIP712MessageTypes,
      EIP712AttestationParams
    >(params, {
      domain: this.getDomainTypedData(),
  ...
  public static hashTypedData<
    T extends EIP712MessageTypes,
    P extends EIP712Params,
  >(params: P, types: EIP712TypedData<T, P>): string {
    return TypedDataEncoder.hash(types.domain, types.types, params);
  }

  public static async signTypedDataRequest<
    T extends EIP712MessageTypes,
    P extends EIP712Params,
  >(
    params: P,
  ...
  public static verifyTypedDataRequestSignature<
    T extends EIP712MessageTypes,
    P extends EIP712Params,
  >(attester: string, request: EIP712Request<T, P>): boolean {
